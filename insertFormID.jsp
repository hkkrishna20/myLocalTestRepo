...
<title>integration Form ID insertion</title>
...
<body>
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
			<form class="form-horizontal" role="form" action="formInsert"
				method="post">
				<fieldset>
					<!-- Form Name -->
					<legend> Form Insertion </legend>


					<div class="form-group">
						<div class="pure-control-group">
							<label class="col-sm-4 control-label" for="textinput">Parent
								Id</label>
							<div class="col-sm-8">
								<input type="text" name="parentId" id="parentId"
									placeholder="Parent Id" class="form-control">
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="pure-control-group">
							<label class="col-sm-4 control-label" for="textinput">template
								Id</label>
							<div class="col-sm-8">
								<input type="text" name="templateId" id="templateId"
									placeholder="templateId" class="form-control">
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="pure-control-group">
							<label class="col-sm-4 control-label" for="textinput">productFamily</label>
							<div class="col-sm-8">
								<input type="text" name="productFamily" id="productFamily"
									placeholder="productFamily" class="form-control">
							</div>
						</div>
					</div>
					<div id="newlink">
						...
						<div class="pure-control-group">
							...
							<div class="col-sm-8">
								<input type="text" name="formTitle" id="formTitle"
									placeholder="formTitle" class="form-control">
